 ...
 */
public class notificationFragment extends Fragment implements audioListAdapter.onItemListClick {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
       ...
       arrayList= new ArrayList<File>();
        ...
        Set<String> set = prefs.getStringSet("Fav", null);
        List<String> sample=new ArrayList<String>(set);
        Log.e("list",new File(sample.get(0)).getName());
        for (int i=0; i<sample.size(); i++){
           arrayList.add(new File(sample.get(i)));
        }
        AudioListAdapter = new audioListAdapter(arrayList,this);
